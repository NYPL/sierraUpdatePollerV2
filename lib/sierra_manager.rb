...
class SierraManager
    ...
    def fetch_updated_records
        ...
        while @processing do
            results = self._fetch_record_batch
            self._parse_result_batch results
        end
    end
    ...
    def _fetch_record_batch
        ...
        self._query_sierra_api param_array
    end
    ...
    def _query_sierra_api param_array
        ...
        begin
            ...
            raise SierraError.new("Received error from Sierra API. Review logs")
        end
    ...
    def _process_error results
        ...
        if results.code == 404
            ...
            raise SierraError.new("Received unexpected #{results.code} from Sierra API")
        end
    end
