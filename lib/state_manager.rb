...
class StateManager
  ...
  def fetch_current_state
    ...
    unless status_body["record_type"] == ENV["RECORD_TYPE"]
      ...
      raise S3Error, "Loaded JSON file for incorrect record type"
    end
